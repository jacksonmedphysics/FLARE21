...
filter_depths=[16,32,64,128,256,64,2]
...
def build_model(inp_shape,k_size=3):
    ...
    pool4,skip4=double_conv_block_down(pool3,filter_depths[3],filter_depths[4],k_size)
    bottom_u=Convolution3D(padding='same',filters=filter_depths[4],kernel_size=k_size)(pool4)
    ...
    bottom_u=BatchNormalization()(bottom_u)
    bottom_u=Activation('relu')(bottom_u)
    up1=upsample_merge_double_conv(bottom_u,skip4,filter_depths[4],filter_depths[4],k_size=3)
    up2=upsample_merge_double_conv(up1,skip3,filter_depths[3],filter_depths[3],k_size=3)
